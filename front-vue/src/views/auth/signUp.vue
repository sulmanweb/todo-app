    ...
    <div class="max-w-xl mx-auto mt-2 md:mt-8 lg:mt-16">
      ...
      <div class="bg-white p-8 shadow rounded-lg">
        ...
        <svg
          ...
          class="h-32 w-full mb-4 md:h-48"
          data-name="Layer 1"
        ...
        >
          ...
          <rect x="65.88" y="134" width="365.14" height="232.26" fill="#414141" opacity="0.2" />
          <rect
            y="101.61"
            width="418.74"
            height="237.84"
          ...
          />
          <rect x="36.85" y="156.33" width="134" height="142.93" fill="#414141" />
          <path
            ...
            fill="#fff"
          />
          <rect x="4.47" y="106.08" width="408.69" height="30.15" fill="#414141" />
          <rect x="225.56" y="198.2" width="155.21" height="10.05" fill="#e0e0e0" />
          <rect x="225.56" y="240.64" width="155.21" height="10.05" fill="#f5f5f5" />
          <rect x="224.45" y="219.42" width="91.56" height="10.05" fill="#414141" opacity="0.2" />
          ...
          />
          <rect x="185.36" y="585.12" width="53.6" height="18.98" fill="#414141" />
          ...
          />
          <rect x="418.74" y="654.35" width="305.96" height="54.72" fill="#414141" />
          ...
          />
          <rect x="537.11" y="101.61" width="187.6" height="134" fill="#414141" />
          <rect x="537.11" y="101.61" width="187.6" height="134" fill="#fff" opacity="0.2" />
        </svg>

        <h1 class="text-2xl text-center font-extrabold tracking-wide uppercase">Sign Up</h1>
          ...
          <template v-slot="{mutate, loading, error}">
            ...
            <div class="bg-red-100 border-l-4 border-red-400 p-4" v-if="error">
              <div class="flex">
                ...
                <div class="ml-3">
                  <p
                    class="text-sm leading-5 text-red-700"
                  >{{error.toString().replace('Error: GraphQL error: ', '')}}</p>
                </div>
              </div>
            </div>
            <!-- Sign Up Form -->
